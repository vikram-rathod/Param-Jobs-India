...
import com.app.paramjobsindia.Model.CallingJobModelList;
import com.app.paramjobsindia.R;

import java.util.List;

public class CallingJobAdapter extends RecyclerView.Adapter<CallingJobAdapter.ViewHolder> {

    Context context;
    List<CallingJobModelList> itemlist;

    public CallingJobAdapter(Context context, List<CallingJobModelList> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<CallingJobModelList> filteredListS){
    ...
    @NonNull
    @Override
    public CallingJobAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_layout_recycler,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CallingJobAdapter.ViewHolder holder, int position) {
