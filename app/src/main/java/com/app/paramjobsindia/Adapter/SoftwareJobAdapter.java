...
import com.app.paramjobsindia.Model.SoftwareJobModelList;
import com.app.paramjobsindia.R;

import java.util.List;

public class SoftwareJobAdapter extends RecyclerView.Adapter<SoftwareJobAdapter.ViewHolder> {

    Context context;
    List<SoftwareJobModelList> itemlist;

    public SoftwareJobAdapter(Context context, List<SoftwareJobModelList> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<SoftwareJobModelList> filteredListS){
    ...
    @NonNull
    @Override
    public SoftwareJobAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_layout_recycler,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SoftwareJobAdapter.ViewHolder holder, int position) {
