...
public class OtherJobsAdapter extends RecyclerView.Adapter<OtherJobsAdapter.ViewHolder> {

    Context context;
    List<OtherJobsModelList> itemlist;

    public OtherJobsAdapter(Context context, List<OtherJobsModelList> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<OtherJobsModelList> filteredListS){
    ...
    @NonNull
    @Override
    public OtherJobsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_layout_recycler,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OtherJobsAdapter.ViewHolder holder, int position) {
