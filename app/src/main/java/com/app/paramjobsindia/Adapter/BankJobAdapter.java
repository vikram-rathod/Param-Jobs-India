...
public class BankJobAdapter extends RecyclerView.Adapter<BankJobAdapter.ViewHolder> {

    Context context;
    List<BankJobModelList> itemlist;

    public BankJobAdapter(Context context, List<BankJobModelList> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<BankJobModelList> filteredListS){
    ...
    @NonNull
    @Override
    public BankJobAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_layout_recycler,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BankJobAdapter.ViewHolder holder, int position) {
