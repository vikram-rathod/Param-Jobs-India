...
public class DeliveryAssociateAdapter extends RecyclerView.Adapter<DeliveryAssociateAdapter.ViewHolder> {

    Context context;
    List<DeliveryAssociateModelList> itemlist;

    public DeliveryAssociateAdapter(Context context, List<DeliveryAssociateModelList> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<DeliveryAssociateModelList> filteredListS){
    ...
    @NonNull
    @Override
    public DeliveryAssociateAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_layout_recycler,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DeliveryAssociateAdapter.ViewHolder holder, int position) {
