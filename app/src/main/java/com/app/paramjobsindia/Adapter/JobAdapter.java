...
import com.app.paramjobsindia.Model.JobModelList;
...
public class JobAdapter extends RecyclerView.Adapter<JobAdapter.ViewHolder> {
    ...
    Context context;
    List<JobModelList> itemlist;

    public JobAdapter(Context context, List<JobModelList> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<JobModelList> filteredListS){
