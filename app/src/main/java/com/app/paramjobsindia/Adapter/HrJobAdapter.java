...
import com.app.paramjobsindia.Model.HrJobModelList;
import com.app.paramjobsindia.R;

import java.util.List;

public class HrJobAdapter extends RecyclerView.Adapter<HrJobAdapter.ViewHolder> {

    Context context;
    List<HrJobModelList> itemlist;

    public HrJobAdapter(Context context, List<HrJobModelList> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<HrJobModelList> filteredListS){
    ...
    @NonNull
    @Override
    public HrJobAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_layout_recycler,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HrJobAdapter.ViewHolder holder, int position) {
