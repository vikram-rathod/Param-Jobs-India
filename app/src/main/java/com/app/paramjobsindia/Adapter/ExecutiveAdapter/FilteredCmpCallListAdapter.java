...
public class FilteredCmpCallListAdapter extends RecyclerView.Adapter<FilteredCmpCallListAdapter.ViewHolder> {

    Context context;
    List<FilteredCmpCallListmodel> itemlist;

    public FilteredCmpCallListAdapter(Context context, List<FilteredCmpCallListmodel> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<FilteredCmpCallListmodel> filteredListS){
