...
public class FilteredPendCallListAdapter extends RecyclerView.Adapter<FilteredPendCallListAdapter.ViewHolder> {

    Context context;
    List<FilteredPendCallListmodel> itemlist;

    public FilteredPendCallListAdapter(Context context, List<FilteredPendCallListmodel> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<FilteredPendCallListmodel> filteredListS){
