...
public class TodaysCmpCallListAdapter extends RecyclerView.Adapter<TodaysCmpCallListAdapter.ViewHolder> {

    Context context;
    List<TodaysCmpCallListModel> itemlist;

    public TodaysCmpCallListAdapter(Context context, List<TodaysCmpCallListModel> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<TodaysCmpCallListModel> filteredListS){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.recycler_item_todayscompletecalllist,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txtsr = itemView.findViewById(R.id.todaycmpcalllistsrno);
            txtcustN = itemView.findViewById(R.id.todaycmpcalllistcname);
            txtcustMobN = itemView.findViewById(R.id.todaycmpcalllistmn);
            txtflDate = itemView.findViewById(R.id.todaycmpcalllistdate);
            txtfldesc = itemView.findViewById(R.id.todaycmpcalllistfdesc);
            txtflmodname = itemView.findViewById(R.id.todaycmpcalllistflmname);
            imgwh = itemView.findViewById(R.id.whaptodayscmpcalllist);
            imgcl = itemView.findViewById(R.id.calltodayscmpcalllist);
            imgedit = itemView.findViewById(R.id.edittodayscmpcalllist);
        }
    }
}
