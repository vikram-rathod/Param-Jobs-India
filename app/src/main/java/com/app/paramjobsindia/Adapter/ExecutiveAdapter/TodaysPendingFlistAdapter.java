...
public class TodaysPendingFlistAdapter extends RecyclerView.Adapter<TodaysPendingFlistAdapter.ViewHolder> {

    Context context;
    List<TodaysPendingFlistModel> itemlist;

    public TodaysPendingFlistAdapter(Context context, List<TodaysPendingFlistModel> itemlist) {
        this.context = context;
        this.itemlist = itemlist;
    }

    //search bar//
    public void setFilteredListS(List<TodaysPendingFlistModel> filteredListS){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.recycler_item_todayspendinf_fl_list,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txtsr = itemView.findViewById(R.id.todaypendfllistsrno);
            txtcustN = itemView.findViewById(R.id.todaypendfllistcname);
            txtcustMobN = itemView.findViewById(R.id.todaypendfllistmn);
            txtflDate = itemView.findViewById(R.id.todaypendfllistdate);
            txtfldesc = itemView.findViewById(R.id.todaypendfllistfdesc);
            txtflmodname = itemView.findViewById(R.id.todaypendfllistflmname);
            imgwh = itemView.findViewById(R.id.whaptodaypendfl);
            imgcl = itemView.findViewById(R.id.calltodaypendfl);
            imgedit = itemView.findViewById(R.id.edittodaypendfl);
