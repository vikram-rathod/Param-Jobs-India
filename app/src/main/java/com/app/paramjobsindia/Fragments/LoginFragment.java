...
public class LoginFragment extends Fragment {
    TextView shownumber,newcandidate,timmer,toastmsg;
    Button smtbtn;
    LinearLayout timmer_layout,layout;
    EditText mobno,otp;
    RadioGroup rgb;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sharedPreferences_candidate = requireContext().getSharedPreferences(SHARED_PREF_NAME_CANDIDATE, Context.MODE_PRIVATE);
        sharedPreferences_company =requireContext().getSharedPreferences(SHARED_PREF_NAME_COMPANY, Context.MODE_PRIVATE);

        mobno=view.findViewById(R.id.mobnologin);
        otp=view.findViewById(R.id.otpcandidatelogin);
        newcandidate=view.findViewById(R.id.newuser);
        smtbtn=view.findViewById(R.id.logincanbtn);
        timmer=view.findViewById(R.id.countdowntimmer);
        timmer_layout=view.findViewById(R.id.timmerlayout);
        rgb =  view.findViewById(R.id.loginrgb);
        rbcandidate=view.findViewById(R.id.loginrbcandidate);
        rbcompany= view.findViewById(R.id.loginrbcmpany);
        nextbtn=view.findViewById(R.id.gonextlogin);
        shownumber=view.findViewById(R.id.mobnumberlogin);
        layout=view.findViewById(R.id.lllogin);
        toastmsg=view.findViewById(R.id.toast);


        //if not an account
        newcandidate.setOnClickListener(v ->  {

                Intent i=new Intent(getContext(), CreateNewAccCandidateActivity.class);
                startActivity(i);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                rb = (RadioButton) view.findViewById(sid);
                if (sid == -1) {
                    Toast.makeText(getContext(), "Please select Option", Toast.LENGTH_LONG).show();
                } else {
...
//                        Saving values to editor
                            ...
                            Intent j=new Intent(getContext(), CandidateMainActivity.class);
                            startActivity(j);
                        }

                    }else {
                        Toast.makeText(getContext(), "Incorrect Mobile no & Password", Toast.LENGTH_SHORT).show();
                    }
...
//                        Saving values to editor
                            ...
                            Intent j=new Intent(getContext(), CompanyMainActivity.class);
                            startActivity(j);
                        }
