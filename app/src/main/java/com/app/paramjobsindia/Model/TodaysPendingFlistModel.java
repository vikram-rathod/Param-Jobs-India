...
public class TodaysPendingFlistModel {
    ...
    public TodaysPendingFlistModel(String excel_cust_id, String user_assign_data_id, String excel_cust_name,
                                   String excel_cust_mobileno, String follow_up_date,
                                   String follow_up_desc, String follow_up_mod_name) {
