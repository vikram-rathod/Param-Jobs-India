...
public class AppliedJobModelList {
    String job_id,job_title,bu_cat_id,get_compname,company_id,qualification_namw,job_type,
    ...
    public AppliedJobModelList(String job_id, String job_title, String bu_cat_id,
