...
public class EqModelList {
    String excel_cust_id,excel_cust_name,excel_cust_mobileno,follow_up_date,follow_up_desc,follow_up_mod_name;

    public EqModelList(String excel_cust_id, String excel_cust_name, String excel_cust_mobileno,
                       String follow_up_date, String follow_up_desc, String follow_up_mod_name) {
