...
public class PostedJbListModel {

    String job_cat_name,job_id,job_title,bu_cat_id,get_compname,company_id,qualification_namw,
            job_type,job_salary,job_education,job_location,job_note,job_interview_date,
            job_interview_time,job_opening,jobpost_status,pro_img;

    public PostedJbListModel(String job_cat_name, String job_id, String job_title, String bu_cat_id, String get_compname, String company_id, String qualification_namw, String job_type, String job_salary, String job_education, String job_location, String job_note,
                             String job_interview_date, String job_interview_time, String job_opening,String jobpost_status, String pro_img) {
        ...
        this.jobpost_status=jobpost_status;
        this.pro_img = pro_img;
    }

    public String getJobpost_status() {
        return jobpost_status;
    }

    public void setJobpost_status(String jobpost_status) {
        this.jobpost_status = jobpost_status;
    }
