...
public class TodaysCmpCallListModel {

    String excel_cust_id,user_assign_data_id,excel_cust_name,excel_cust_mobileno,
            follow_up_date,follow_up_desc,follow_up_mod_name;

    public TodaysCmpCallListModel(String excel_cust_id, String user_assign_data_id,
