...
import com.app.paramjobsindia.Adapter.ExecutiveAdapter.FilteredPendCallListAdapter;
import com.app.paramjobsindia.Model.FilteredPendCallListmodel;
...
public class FilteredPendCallListActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    FilteredPendCallListAdapter filteredPendCallListAdapter;
    List<FilteredPendCallListmodel> list2=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filtered_pend_call_list);
        ...
        recyclerView2=findViewById(R.id.rvfilteredpendcl);//initializing recycler view
        LinearLayoutManager layoutManager=new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.VERTICAL,false);
        recyclerView2.setLayoutManager(layoutManager);
        
        filteredPendCallListAdapter=new FilteredPendCallListAdapter(getApplicationContext(),list2);
        recyclerView2.setAdapter(filteredPendCallListAdapter);
        ...
        toolbar=findViewById(R.id.toolbarfilteredpendcl);
...
//                            list.add(listModel);
                            ...
                            FilteredPendCallListmodel model = new FilteredPendCallListmodel(excel_cust_id,user_assign_data_id, excel_cust_name,
                                    excel_cust_mobileno, follow_up_date,follow_up_desc,follow_up_mod_name);
...
//                sortListCallAdapter.notifyDataSetChanged();
                ...
                String l=String.valueOf(filteredPendCallListAdapter.getItemCount());
                Log.d("size",l);
                filteredPendCallListAdapter.notifyDataSetChanged();
