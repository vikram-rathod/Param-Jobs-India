...
import com.app.paramjobsindia.Adapter.ExecutiveAdapter.FilteredSortListCallAdapter;
...
public class FilteredSortListActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    FilteredSortListCallAdapter filteredSortListCallAdapter;
    List<FilteredSortListmodel> list2=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filtered_sort_list);
        ...
        recyclerView2=findViewById(R.id.rvfilteredsortleqcalls);//initializing recycler view
        LinearLayoutManager layoutManager=new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.VERTICAL,false);
        recyclerView2.setLayoutManager(layoutManager);
        
        filteredSortListCallAdapter=new FilteredSortListCallAdapter(getApplicationContext(),list2);
        recyclerView2.setAdapter(filteredSortListCallAdapter);
        ...
        toolbar=findViewById(R.id.toolbarfsortleqcalls);
...
//                            list.add(listModel);
                            ...
                            FilteredSortListmodel model = new FilteredSortListmodel(excel_cust_id,user_assign_data_id, excel_cust_name,
                                    excel_cust_mobileno, follow_up_date,follow_up_desc,follow_up_mod_name);
...
//                sortListCallAdapter.notifyDataSetChanged();
                ...
                String l=String.valueOf(filteredSortListCallAdapter.getItemCount());
                Log.d("size",l);
                filteredSortListCallAdapter.notifyDataSetChanged();
