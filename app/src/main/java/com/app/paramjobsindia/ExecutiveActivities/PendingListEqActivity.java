...
import com.app.paramjobsindia.Adapter.ExecutiveAdapter.TodaysPendingFlistAdapter;
import com.app.paramjobsindia.Model.SelectFSModel;
import com.app.paramjobsindia.Model.TodaysPendingFlistModel;
...
public class PendingListEqActivity extends AppCompatActivity {
    Toolbar toolbar;
    TodaysPendingFlistAdapter todaysPendingFlistAdapter;
    List<TodaysPendingFlistModel> list=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_list_eq);
        imgRefresh=findViewById(R.id.refreshimgpendlist);//initialize floating button
        spinnerf=findViewById(R.id.sppendcalll);
        fldatebtn=findViewById(R.id.pendcallldatepicker);
...
//                Toast.makeText(getContext(), spinc.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
        ...
        recyclerView=findViewById(R.id.rvtodaypendlistfl);//initializing recycler view
        ...
        todaysPendingFlistAdapter=new TodaysPendingFlistAdapter(getApplicationContext(),list);
        recyclerView.setAdapter(todaysPendingFlistAdapter);
        ...
        //searchbar//
        searchView=findViewById(R.id.searchtodaypendlistfl);
...
//                filterlistS(newTextS);
                ...
                Intent intent=new Intent(getApplicationContext(),FilteredPendCallListActivity.class);
        ...
        toolbar=findViewById(R.id.toolbartodaypendlistfl);
...
//        fldatebtn.setText(date);
        ...
        datePickerDialog=new DatePickerDialog(PendingListEqActivity.this,style,dateSetListener,year,month,day);
    }
///date picker function
...
//                        Log.d("s", String.valueOf(cllist));
    ...
    private void filterlistS(String newTextS) {
        ...
        List<TodaysPendingFlistModel> filteredListS=new ArrayList<>();

        for(TodaysPendingFlistModel listS: list){
        ...
        if (filteredListS.isEmpty()){
            ...
            todaysPendingFlistAdapter.setFilteredListS(filteredListS);
        }
    }
    ...
    private void getCustData() {
        ...
        RequestQueue queue= Volley.newRequestQueue(getApplicationContext());
        String url="https://comzent.in/comzentapp/apis/get_today_pending_followup_list.php";
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if(msg.equals("Success")) {
                        ...
                        JSONArray jsonArray=jsonObject.getJSONArray("today_followup_pending");
                        for(int i=0;i<= jsonArray.length();i++) {
                            ...
                            TodaysPendingFlistModel listModel = new TodaysPendingFlistModel(excel_cust_id,user_assign_data_id, excel_cust_name,
                ...
                String l=String.valueOf(todaysPendingFlistAdapter.getItemCount());
                Log.d("size",l);
                todaysPendingFlistAdapter.notifyDataSetChanged();
